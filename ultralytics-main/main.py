...
#     # 推理：
    ...
    # 分割：
      ...
      model.predict(source='ultralytics/assets', show=True, save=True, classes=[2])
    ...
    # 检测、跟踪、姿态估计：
      ...
      # # Train the model
      # model.train(data='ultralytics/cfg/datasets/coco.yaml', epochs=100, imgsz=640, save_period=5, device='cpu',batch=2)
      '''model = YOLO('best.pt')
      model.predict(source='ultralytics/assets', show=True, save=True)'''
